...
<head>
  ...
  <style type="text/css">
    ...
    .navbar-nav li:hover .form-container {
      z-index: 2;
      opacity: 1;
      visibility: visible;
      top: 51px;
    ...
    .form__span {
      color: #51b0cf;
      font-size: 20px;
      border-bottom: 1px dashed #51b0cf;
      font-weight: 400;
    }
  </style>
</head>
          ...
          <li>
            ...
            <div class="form-container">
              <form class="form">
                ...
                <div class="input__wrapper">
                  <label for="place">Placeholder</label>
          ...
          <li class="dropdown">
            ...
            foreach ($categories as $category) {
                if ($category == 'Комп`ютери') {
                    echo '<li class="dropdown-submenu extra">';
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <h3>Завдання 2</h3>
        <ul>
          <li>При наведенні на категорію "Комп`ютери", показувати список підкатегорій (без JS, використати масив PHP
            <b>$sub_categories</b>)
          </li>
          <li>Не наводячи на пункт "Комп`ютери" потрібно, щоб візуально було видно і зрозуміло, що в ньому є список
            підкатегорій</li>
      ...
      <div class="col-sm-4">
        <h3>Завдання 3: </h3>
        <ul>
          <li>Максимально точно зверстати форму по макету вказаному нижче (звернути увагу, що input та checkbox мають не
            стандартний вид!)</li>
